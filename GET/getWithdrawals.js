...
async function getWithdrawalsByIdentityId(identityId) {
  const apiUrl = `https://api.orangepill.cloud/v1/transactions/all?scope=-own,all&query={"type":"withdrawal","source.holder":"${identityId}"}`;
